...
const Navbar = () => {
  const [isOpen, setIsOpen] = useState(false);//used for open close the menu after move to an item of menu
    ...
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <div className='text-lg font-semibold cursor-pointer'>
          ...
          <span className='text-white'>Geetanjali</span>
          <span className='text-[#8245ec]'>/</span>
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <a
            href="https://www.linkedin.com/in/geetanjali-sahu-94266b246/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-white"
          >
